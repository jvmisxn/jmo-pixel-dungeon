...
7. Add missing mobs and variants such as Ghoul/Gnoll Geomancer/crystal mimic behavior where upstream requires them. (2026-07-30: Ghoul DONE — pair spawn + GhoulLifeLink revive + upstream city spawn rotation, `test_ghoul.gd`; rare variants Albino/CausticSlime/ArmoredBrute/Senior/Acidic and crystal mimic still missing.) (2026-07-30: rare-alt swap mechanism DONE — MobFactory.apply_rare_alt 1/50 per upstream MobSpawner.RARE_ALTS, Albino shipped, bandit/dm201 moved to swap-only, test_rare_mob_alts.gd; remaining variants join the map as ported.) (2026-07-30: CausticSlime shipped — ACIDIC + Ooze immunity + 1/2 Ooze on hit, slime.png row-1 sprite, base Slime name fix, test_caustic_slime.gd; GooBlob corpse drop deferred with alchemy ingredients. Remaining alts: ArmoredBrute, Senior, Acidic + unported-base ones.) (2026-07-30: ArmoredBrute shipped — +4 flat DR, HT/2+1 rage shield via Brute._rage_shield hook, guaranteed scale/plate armor drop, brute.png row-1 ShieldedSprite + real brute frame maps, test_armored_brute.gd. Remaining alts: Senior, Acidic.) (2026-07-30: Senior shipped — full Monk.java parity rewrite first (stats, 0.5x attack delay, MonkFocus parry buff, vanilla disarm removed), then Senior 16-25 dmg + guaranteed pasty + 2.33 travel focus bonus, monk.png row-1 sprite + real MonkSprite frames, test_senior_monk.gd. Remaining alts: Acidic.) (2026-07-30: Acidic shipped — full Scorpio.java parity rewrite first (110 HP, 30-40 dmg, ranged-only + hunting retreat, 1/2 cripple, filtered potion loot), then Acidic Ooze-on-hit + adjacent melee splash + guaranteed potion of experience, scorpio.png row-1 sprite + real ScorpioSprite frames, test_acidic_scorpio.gd. Rare-alt roster for ported base mobs is COMPLETE; crystal mimic + alts of unported base mobs remain.) (2026-07-30: CrystalMimic behavior DONE — steal-not-bite neutral attack, flee+Haste reveal, victim-fling hostile proc, 6+-tile out-of-LOS escape with loot, uncursed-contents prize, mimic.png row 2, test_crystal_mimic.gd; NOT yet spawnable — CrystalVaultRoom places no chests, vault-contents parity is the wiring slice in backlog.) (2026-07-30: base Mimic stat/loot parity DONE — setLevel-driven stats, EXP 0, DEMONIC, generatePrize extra reward, no invented gold drop, test_mimic_loot.gd; crystal mimic still remains, blocked on a hero interact/open path for the NEUTRAL surprise-bite + flee/steal behavior.) (2026-07-30: hidden-mimic interact/open path DONE — can_interact + free neutral bite with INFINITE_ACCURACY and fixed 2+2*level damage, invisible-hero exemption, no bonus on damage reveals, test_mimic_surprise_bite.gd; CrystalMimic flee/steal is now unblocked and the last missing mimic behavior.)
8. Add missing foods and Blandfruit/cooking chain. (2026-07-30: mystery-meat family DONE — upstream MysteryMeat/FrozenCarpaccio effect tables, ChargrilledMeat item, Frost-buff inventory conversion (was a silent no-op on real heroes), test_mystery_meat_family.gd; remaining: StewedMeat/alchemy-pot cooking, Blandfruit chain, Berry/PhantomMeat, Heap burn/freeze wiring — see backlog.)
9. Add armor curse glyphs. (2026-07-30 source check: already DONE — all 8 upstream curse glyphs live in src/items/armor/curse_glyph.gd.)
