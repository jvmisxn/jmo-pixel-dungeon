...
const CASES: Array[String] = [
	...
	"res://tests/cases/test_scheduler_mechanics.gd",
	...
	"res://tests/cases/test_wand_of_frost_chill.gd",
	...
	"res://tests/cases/test_grim_tracker.gd",
	...
	"res://tests/cases/test_press_cell.gd",
	...
	"res://tests/cases/test_chasm_jump.gd",
	"res://tests/cases/test_chasm_levitation.gd",
	...
	"res://tests/cases/test_examine_info_windows.gd",
	...
	"res://tests/cases/test_blast_wave_chasm.gd",
	"res://tests/cases/test_forced_knockback_chasm.gd",
	"res://tests/cases/test_geyser_chasm_knockback.gd",
	...
	"res://tests/cases/test_mob_nearest_hero.gd",
	...
	"res://tests/cases/test_generated_level_doors.gd",
	"res://tests/cases/test_secret_room_placement.gd",
	"res://tests/cases/test_mob_action_visibility_coalesce.gd",
	"res://tests/cases/test_fog_spawn_sprite_gating.gd",
	"res://tests/cases/test_heap_top_item_icon.gd",
	"res://tests/cases/test_tunnel_gated_breach.gd",
	"res://tests/cases/test_mimic_loot.gd",
	"res://tests/cases/test_mimic_surprise_bite.gd",
	"res://tests/cases/test_crystal_mimic.gd",
	"res://tests/cases/test_crystal_vault_contents.gd",
	"res://tests/cases/test_fury_damage.gd",
	"res://tests/cases/test_damage_roll_distribution.gd",
	"res://tests/cases/test_combat_buffs.gd",
	"res://tests/cases/test_buff_key_lookup.gd",
	"res://tests/cases/test_buff_index.gd",
	...
	"res://tests/cases/test_ally_floor_follow.gd",
	...
	"res://tests/cases/test_healing_cure_parity.gd",
	"res://tests/cases/test_liquid_nature.gd",
	...
	"res://tests/cases/test_item_catalog_load_coerce.gd",
	"res://tests/cases/test_imbue_procs.gd",
	"res://tests/cases/test_transmutation_fallback.gd",
	"res://tests/cases/test_amulet_surface_ascend.gd",
	"res://tests/cases/test_descend_sfx_gate.gd",
	"res://tests/cases/test_weapon_charger.gd",
	"res://tests/cases/test_deepest_floor_stat.gd",
	"res://tests/cases/test_quickslot_throw_targeting.gd",
	"res://tests/cases/test_weapon_ability_cleave.gd",
	"res://tests/cases/test_weapon_ability_heavy_blow.gd",
	"res://tests/cases/test_weapon_ability_sneak.gd",
	"res://tests/cases/test_weapon_ability_spike.gd",
	"res://tests/cases/test_weapon_ability_lunge.gd",
	"res://tests/cases/test_weapon_ability_guard.gd",
	"res://tests/cases/test_weapon_ability_combo.gd",
	"res://tests/cases/test_weapon_ability_dance.gd",
	"res://tests/cases/test_weapon_ability_defensive_stance.gd",
	"res://tests/cases/test_weapon_ability_runic_slash.gd",
	"res://tests/cases/test_weapon_ability_spin.gd",
	"res://tests/cases/test_weapon_ability_retribution.gd",
	"res://tests/cases/test_varied_charge.gd",
	"res://tests/cases/test_flail_no_surprise.gd",
	"res://tests/cases/test_monk_energy.gd",
	"res://tests/cases/test_monk_flurry_ability.gd",
	"res://tests/cases/test_monk_focus_ability.gd",
	"res://tests/cases/test_monk_dash_ability.gd",
	"res://tests/cases/test_monk_dragon_kick_ability.gd",
	"res://tests/cases/test_monk_meditate_ability.gd",
	"res://tests/cases/test_wnd_monk_abilities.gd",
	...
	"res://tests/cases/test_weapon_ability_offhand.gd",
	"res://tests/cases/test_combined_lethality.gd",
	"res://tests/cases/test_champion_weapon_swap.gd",
	"res://tests/cases/test_subclass_choice.gd",
	"res://tests/cases/test_ghoul.gd",
	"res://tests/cases/test_rare_mob_alts.gd",
	"res://tests/cases/test_caustic_slime.gd",
	"res://tests/cases/test_armored_brute.gd",
	"res://tests/cases/test_senior_monk.gd",
	"res://tests/cases/test_acidic_scorpio.gd",
	"res://tests/cases/test_amok_targeting.gd",
	"res://tests/cases/test_mystery_meat_family.gd",
	"res://tests/cases/test_heap_burn_freeze.gd",
	"res://tests/cases/test_unique_flag_parity.gd",
	...
	"res://tests/cases/test_surprise_damage_boost.gd",
	"res://tests/cases/test_missile_durability_scaling.gd",
	"res://tests/cases/test_belongings_round_trip.gd",
]
